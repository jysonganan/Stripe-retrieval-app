...
import { nodeChildToString, nodeName } from './print.mjs';

const IS_NODE = Symbol.for('RemoteUiTesting.Node');
function createTestRoot() {
  return createRemoteRoot(() => {});
}
function mount(run, root = createTestRoot()) {
  ...
  function createNodeFromRemoteChild(child) {
    return isRemoteText(child) ? child.text : createNode({
      type: child.type,
      props: { ...child.props
      },
      instance: child,
...
export { createTestRoot, isNode, mount };
