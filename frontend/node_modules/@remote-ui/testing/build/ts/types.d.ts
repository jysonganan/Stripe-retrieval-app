...
export interface Node<Props> {
    ...
    is<Type extends RemoteComponentType<string, any, any>>(type: Type): this is Node<PropsForRemoteComponent<Type>>;
    find<Type extends RemoteComponentType<string, any, any>>(type: Type, props?: Partial<PropsForRemoteComponent<Type>>): Node<PropsForRemoteComponent<Type>> | null;
    findAll<Type extends RemoteComponentType<string, any, any> | string>(type: Type, props?: Partial<PropsForRemoteComponent<Type>>): Node<PropsForRemoteComponent<Type>>[];
...
declare type DeepPartial<T> = T extends (infer U)[] ? DeepPartial<U>[] : T extends ReadonlyArray<infer U> ? ReadonlyArray<DeepPartial<U>> : T extends object ? {
