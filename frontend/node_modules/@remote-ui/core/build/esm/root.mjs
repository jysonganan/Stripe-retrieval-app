import { KIND_ROOT, ACTION_MOUNT, ACTION_INSERT_CHILD, KIND_TEXT, ACTION_REMOVE_CHILD, KIND_COMPONENT, ACTION_UPDATE_PROPS, ACTION_UPDATE_TEXT, KIND_FRAGMENT } from './types.mjs';
