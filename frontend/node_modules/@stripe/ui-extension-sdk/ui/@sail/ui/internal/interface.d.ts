...
import { ReactNode, Key, ReactElement, Ref } from 'react';
...
interface SerializedStylesShape {
    dependencies: Record<string | symbol, string[]>;
    insertedAs: string[];
    key: string;
...
declare type PropsShape<Props, MergedProps> = MergedProps & {
    uses?: (Intent | Intent<Props> | Partial<MergedProps> | null)[];
};
...
interface TabsProps$1 {
     ...
     */
    onSelectionChange?: (arg: string | number) => void;
    dir?: string;
}
/**
 * @external
...
export { AccordionItemProps, AccordionProps, BadgeProps, BannerProps, ButtonGroupProps, ButtonProps, CheckboxProps, ChipListProps, ChipProps, DividerProps, FormFieldGroupProps, IconProps, LinkProps, ListItemProps, ListProps, MenuGroupProps, MenuItemProps, MenuProps, NoticeProps, Properties, RadioProps, SelectProps, SpinnerProps, StylableProps, SwitchProps, TabListProps, TabPanelProps, TabPanelsProps, TabProps, TableBodyProps, TableCellProps, TableFooterProps, TableHeadProps, TableHeaderCellProps, TableProps, TableRowProps, TabsProps, TailorDateFieldProps, TextAreaProps, TextFieldProps, TokenizedCSSProperties, TokenizedPropertiesUnfiltered, TooltipProps };
