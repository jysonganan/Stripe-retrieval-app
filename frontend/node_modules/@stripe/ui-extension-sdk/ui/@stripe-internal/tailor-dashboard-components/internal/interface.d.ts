...
/** @external */
declare const ContextView: (props: Props$3) => JSX.Element;
interface Props$2 {
    /**
...
/** @external */
declare const FocusView: (props: Props$2) => JSX.Element;
interface BaseProps {
    /**
...
declare type Props$1 = BaseProps & (SrcProps | SrcSetProps);
/** @external */
declare const Img: (props: Props$1) => JSX.Element;
interface Props {
    /**
...
export { BarChartProps, ContextViewProps, FocusViewProps, ImgProps, LineChartProps, SettingsViewProps };
